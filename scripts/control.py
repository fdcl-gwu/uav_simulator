...
class Control:
    ...
    def position_control(self):
        ...
        b3 = R.dot(e3)
        b3_dot = R.dot(hatW).dot(e3)  # eq (22)
        f_total = -A.dot(b3)
        ...
        A2 = -hat_b1d.dot(b3c)
        A2_dot = - hat_b1d_dot.dot(b3c) - hat_b1d.dot(b3c_dot)
        A2_2dot = - hat(b1d_2dot).dot(b3c) \
            - 2.0 * hat_b1d_dot.dot(b3c_dot) \
            - hat_b1d.dot(b3c_2dot)
        ...
        b1c = hat_b2c.dot(b3c)
        b1c_dot = hat_b2c_dot.dot(b3c) + hat_b2c.dot(b3c_dot)
        b1c_2dot = hat(b2c_2dot).dot(b3c) \
            + 2.0 * hat_b2c_dot.dot(b3c_dot) \
            + hat_b2c.dot(b3c_2dot)
        ...
        self.wc3_dot = e3.dot(R_T.dot(Rd).dot(Wd_dot)) \
            - e3.dot(hatW.dot(R_T).dot(Rd).dot(Wd))
